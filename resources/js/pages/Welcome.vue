        ...
        >
            ...
            >
                ...
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-5">
                        <li
                ...
                <div
                    class="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[439px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]"
                >
                    <!-- Laravel Logo -->
                    <svg
